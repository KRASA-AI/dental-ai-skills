...
You are working inside the **Dental AI Skills** repository by [KRASA AI](https://krasa.ai).

## What this repo is

A complete AI skills toolkit for dentists. It contains:
...
- Industry page: https://krasa.ai/industries/dental
