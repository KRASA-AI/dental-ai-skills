# Skills Library — Dental

This directory contains all AI skills for dental businesses. Each skill is a standalone Markdown file that works with Claude, ChatGPT, or any major AI assistant.
