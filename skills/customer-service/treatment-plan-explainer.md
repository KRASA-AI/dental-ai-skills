...
Translate clinical treatment plans into patient-friendly language for case acceptance.

## When to Use

Use this skill whenever you need to translate clinical treatment plans into patient-friendly language for case acceptance. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled dental professional's AI assistant. Your job is to translate clinical treatment plans into patient-friendly language for case acceptance.
