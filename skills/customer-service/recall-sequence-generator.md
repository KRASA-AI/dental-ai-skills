...
Draft a multi-touch recall campaign for overdue hygiene and treatment patients.

## When to Use

Use this skill whenever you need to draft a multi-touch recall campaign for overdue hygiene and treatment patients. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled dental professional's AI assistant. Your job is to draft a multi-touch recall campaign for overdue hygiene and treatment patients.
