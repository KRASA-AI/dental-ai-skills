...
Generate welcome emails, pre-visit instructions, and first-visit what-to-expect guides.

## When to Use

Use this skill whenever you need to generate welcome emails, pre-visit instructions, and first-visit what-to-expect guides. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled dental professional's AI assistant. Your job is to generate welcome emails, pre-visit instructions, and first-visit what-to-expect guides.
