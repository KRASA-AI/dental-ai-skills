...
Parse insurance details into a quick-reference sheet of coverage, limits, and waiting periods.

## When to Use

Use this skill whenever you need to parse insurance details into a quick-reference sheet of coverage, limits, and waiting periods. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled dental professional's AI assistant. Your job is to parse insurance details into a quick-reference sheet of coverage, limits, and waiting periods.
...
**Output requirements:**
- Professional formatting appropriate for dental
